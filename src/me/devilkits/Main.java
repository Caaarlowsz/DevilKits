...
import me.devilkits.Warps.*;
import me.devilkits.Seletor.*;
import me.devilkits.Kits.*;
import me.devilkits.Jumps.*;
import me.devilkits.Player.*;
import me.devilkits.Utils.*;
...
public class Main extends JavaPlugin implements Listener
{
    ...
    public void onEnable() {
        ...
        if (economyProvider != null) {
            ...
            if (this.getServer().getPluginManager().getPlugin("BarAPI") == null) {
                Bukkit.getServer().getConsoleSender().sendMessage("§2BarAPI nao esta na pasta!\n          §7Opcao de BossBar anulada!");
            }
        }
    }
    ...
    public boolean onCommand1(final CommandSender sender, final Command command, final String label, final String[] args) {
