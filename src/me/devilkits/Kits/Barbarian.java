...
public class Barbarian implements Listener, CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (label.equalsIgnoreCase("barbarian")) {
            if (!Main.usandokit.contains(p.getName()) && p.hasPermission("kit.barbarian")) {
                p.sendMessage("§7Voce pegou o Kit : §6Barbarian");
                ...
                if (k.getItemInHand().getType() == Material.WOOD_SWORD) {
                    ...
                    if (k.getItemInHand().containsEnchantment(Enchantment.DAMAGE_ALL)) {
                        ...
                        if (lvl + 1 <= max) {
                            ...
                            k.playSound(k.getLocation(), Sound.LEVEL_UP, 1.0f, 1.0f);
                            if (lvl + 1 == 2) {
                                k.sendMessage(ChatColor.GRAY + "UPGRADE! Level " + ChatColor.WHITE + "5");
                            }
                            else if (lvl + 1 == 3) {
                                k.sendMessage(ChatColor.GRAY + "UPGRADE! Level " + ChatColor.WHITE + "6");
                            }
                            else if (lvl + 1 == 4) {
                                k.sendMessage(ChatColor.GRAY + "UPGRADE! Level " + ChatColor.WHITE + "7");
                            }
                            else if (lvl + 1 == 5) {
                                k.sendMessage(ChatColor.GRAY + "UPGRADE! Level " + ChatColor.WHITE + "8");
                            }
                        }
                        else {
                        ...
                        k.playSound(k.getLocation(), Sound.LEVEL_UP, 1.0f, 1.0f);
                        k.sendMessage(ChatColor.GRAY + "UPGRADE! Level " + ChatColor.WHITE + "4");
                    }
                }
            }
        }
