...
public class Batarma extends EntityFishingHook implements Listener
{
    private Snowball sb;
    ...
    public Batarma(final World world, final EntityHuman entityhuman) {
        super((net.minecraft.server.v1_7_R2.World)((CraftWorld)world).getHandle(), entityhuman);
    ...
    public void spawn(final Location location) {
        ...
        ((CraftWorld)location.getWorld()).getHandle().addEntity((net.minecraft.server.v1_7_R2.Entity)this);
    }
