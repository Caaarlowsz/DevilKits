...
public class JellyfishHab implements Listener
{
    ...
    public void colocaragua(final PlayerInteractEvent event) {
        ...
        if (p.getItemInHand().getType() == Material.SLIME_BALL && event.getAction() == Action.RIGHT_CLICK_BLOCK) {
    ...
    public void veneno(final PlayerMoveEvent event) {
        ...
        if (b.getType() == Material.STATIONARY_WATER && !p.getInventory().contains(Material.CLAY_BALL) && JellyfishHab.naoescorrer.contains(b)) {
